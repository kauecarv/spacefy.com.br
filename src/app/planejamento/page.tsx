  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center mt-[-10px] sm:mt-[-20px] md:mt-[-40px] lg:mt-[-140px] py-4 px-4 z-10">
        ...
        >
          Transforme suas <span className="text-indigo-600">Ideias</span> em{" "}
          <span className="text-indigo-600">Realidade Digital</span>
        </motion.h1>
        <motion.p
        ...
        >
          Está pronto para ter um site que vai{" "}
          <span className="text-spacefy font-semibold text-lg">
            aumentar suas vendas
          </span>{" "}
          e acessos de forma impactante? Preencha este formulário e acelere o{" "}
          <span className="text-spacefy font-semibold text-lg">
        ...
        >
          ...
          <IoMdHelp className="text-spacefy text-3xl -mt-1" />
        </motion.h1>
        ...
        <div className="w-full max-w-6xl mt-16">
          <div className="flex flex-col items-center sm:items-start gap-3 px-6 mb-8">
            ...
            <motion.h2
              ...
              viewport={{ once: true }}
            >
              Explore Nosso <span className="text-indigo-600">Universo</span> de{" "}
              <span className="text-indigo-600">Criações</span>
            </motion.h2>
