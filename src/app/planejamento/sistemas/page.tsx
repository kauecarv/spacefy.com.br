...
import { RiMailSendLine, RiPhoneLine, RiUserSmileLine } from "react-icons/ri";
  ...
  const steps: Step[] = [
    {
      ...
      subtitle:
        "O primeiro passo para transformar sua visão em um sistema incrível começa aqui.",
    },
    {
      fields: [
        {
          ...
          name: "necessidades",
          description:
            "Descreva em detalhes as funcionalidades e recursos que seu sistema precisa ter",
        },
      ],
      title: "Quais são as necessidades para o sistema?",
      subtitle:
        "Descreva como é o seu sistema ou o que você precisa que ele faça",
    },
    {
      fields: [
        {
          ...
          name: "objetivo",
          description:
            "Ex: Automatizar processos, gerenciar vendas, controlar estoque",
        },
        {
          type: "select",
      ...
      subtitle:
        "Defina o propósito principal do seu sistema e tecnologias preferidas",
    },
    {
      fields: [
        {
          ...
          name: "bancoDados",
          description:
            "Para armazenar e gerenciar informações de forma persistente",
      ...
      fields: [
        {
          ...
          name: "usuarios",
          description:
            "Selecione o perfil dos usuários que utilizarão o sistema",
          options: [
